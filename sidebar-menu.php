...
if ($_SESSION['permisos_acceso']==1) { ?>
    ...
    <ul class="sidebar-menu"><br><br><br>
  ...
  if ($_GET["module"]=="medicines_transaction" || $_GET["module"]=="form_medicines_transaction") { ?>
    <li class="active">
      <a href="?module=medicines_transaction"><i class="fa fa-clone"></i> Salidas/Entradas </a> 
      </li>
  <?php
  }
	...
	elseif ($_GET["module"]=="stock_report") { ?>
		<li class="active treeview">
      		...
      		<ul class="treeview-menu">
        		...
        		<li class="active"><a href="?module=stock_report"><i class="fa fa-circle-o"></i>Historial Entradas/Salidas</a></li>
      		</ul>
    	</li>
    <?php
	}
		...
		<li class="treeview">
      		...
      		<ul class="treeview-menu">
        		<li><a href="?module=stock_inventory"><i class="fa fa-circle-o"></i> Stock de Medicamentos </a></li>
        		<li><a href="?module=stock_report"><i class="fa fa-circle-o"></i> Historial Entradas/Salidas </a></li>
      		</ul>
    	</li>
    <?php
	}
...
elseif ($_SESSION['permisos_acceso']== 2) { ?>
	<!-- sidebar menu start -->
